...
const Page = async ({ params }: { params: { quesId: string; quesName: string } }) => {
    let question, answers, upvotes, downvotes, comments;
    try {
        [question, answers, upvotes, downvotes, comments] = await Promise.all([
        ...
        return (
            <div className="container mx-auto px-4 pb-20 pt-36">
                <h1 className="text-2xl font-bold text-red-500">Error fetching question data</h1>
                <p className="mt-4 text-neutral-400">{error.message}</p>
                <p className="mt-2 text-sm text-neutral-500">
                    This might happen if the database is still initializing. Please try refreshing the
